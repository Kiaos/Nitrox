...
public class RemotePlayerCinematicController : MonoBehaviour, IManagedUpdateBehaviour, IManagedLateUpdateBehaviour
{
    ...
    public bool animState
    {
        ...
        private set
        {
            ...
            if (receiversAnimParam.Length > 0)
            {
                ...
                {
                    IAnimParamReceiver component = animParamReceivers[i].GetComponent<IAnimParamReceiver>();
                    if (component != null)
                    {
                        component.ForwardAnimationParameterBool(receiversAnimParam, value);
                    }
                }
            }
    ...
    private void SetVrActiveParam()
    {
        ...
        {
            IAnimParamReceiver component = animatedObject.GetComponent<IAnimParamReceiver>();
            if (component != null)
            {
                component.ForwardAnimationParameterBool(paramaterName, vrAnimationMode);
            }
        }
    }
